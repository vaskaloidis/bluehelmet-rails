...
RSpec.describe ContactMessagesController, type: :controller do
  ...
  describe "GET #show" do
    it "assigns the requested contact_message as @contact_message" do
      contact_message = ContactMessage.create! valid_attributes
      get :show, params: {id: contact_message.to_param}, session: valid_session
  ...
  describe "GET #edit" do
    it "assigns the requested contact_message as @contact_message" do
      contact_message = ContactMessage.create! valid_attributes
      get :edit, params: {id: contact_message.to_param}, session: valid_session
      expect(assigns(:contact_message)).to eq(contact_message)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new ContactMessage" do
        expect {
          post :create, params: {contact_message: valid_attributes}, session: valid_session
      ...
      it "redirects to the created contact_message" do
        post :create, params: {contact_message: valid_attributes}, session: valid_session
        expect(response).to redirect_to(ContactMessage.last)
      end
    end

    context "with invalid params" do
      it "assigns a newly created but unsaved contact_message as @contact_message" do
        post :create, params: {contact_message: invalid_attributes}, session: valid_session
        expect(assigns(:contact_message)).to be_a_new(ContactMessage)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested contact_message" do
        contact_message = ContactMessage.create! valid_attributes
        put :update, params: {id: contact_message.to_param, contact_message: new_attributes}, session: valid_session
      ...
      it "assigns the requested contact_message as @contact_message" do
        contact_message = ContactMessage.create! valid_attributes
        put :update, params: {id: contact_message.to_param, contact_message: valid_attributes}, session: valid_session
        expect(assigns(:contact_message)).to eq(contact_message)
      end
      ...
      it "redirects to the contact_message" do
        contact_message = ContactMessage.create! valid_attributes
        put :update, params: {id: contact_message.to_param, contact_message: valid_attributes}, session: valid_session
        expect(response).to redirect_to(contact_message)
      end
    end
    ...
    context "with invalid params" do
      it "assigns the contact_message as @contact_message" do
        contact_message = ContactMessage.create! valid_attributes
        put :update, params: {id: contact_message.to_param, contact_message: invalid_attributes}, session: valid_session
        expect(assigns(:contact_message)).to eq(contact_message)
      end
  ...
  describe "DELETE #destroy" do
    it "destroys the requested contact_message" do
      contact_message = ContactMessage.create! valid_attributes
      expect {
        delete :destroy, params: {id: contact_message.to_param}, session: valid_session
      }.to change(ContactMessage, :count).by(-1)
    end
